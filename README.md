...
Canonical Lane research workspace for a flagship problem in analytic number theory and automorphic forms:
proving holomorphy of nontrivial Artin L-functions in the declared admissible class through an admissible Artin-regularity closure architecture.

## Main Manuscript

- [paper/ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md](paper/ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md`.
...
Current AH runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/ah_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/ah_closure_guard.py`.
...
- Manuscript target: [paper/ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md](paper/ARTIN_HOLOMORPHY_CONJECTURE_PREPRINT.md)
