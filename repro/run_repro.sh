...
mkdir -p .repro_tmp/artin_holomorphy_conjecture
cp artifacts/stitch_constants.json .repro_tmp/artin_holomorphy_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/artin_holomorphy_conjecture/constants_registry.json
python3 scripts/ah_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
